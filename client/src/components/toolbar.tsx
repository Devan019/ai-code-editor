...
export function Toolbar({ showPreview, setShowPreview, showAIAgent, setShowAIAgent }: ToolbarProps) {
  return (
      ...
      <div className="flex items-center space-x-2">
        <motion.button
          ...
          className={`flex items-center space-x-2 px-3 py-1.5 rounded text-sm transition-colors ${
            showPreview ? "bg-[#007acc] text-white" : "bg-[#3c3c3c] text-gray-300 hover:bg-[#4c4c4c]"
          }`}
        >
        ...
        <motion.button
          ...
          className={`flex items-center space-x-2 px-3 py-1.5 rounded text-sm transition-colors ${
            showAIAgent ? "bg-[#007acc] text-white" : "bg-[#3c3c3c] text-gray-300 hover:bg-[#4c4c4c]"
          }`}
        >
